...
get_Dept_Mst(){
  this.api.getDeptMst(this.plant_Code).subscribe(res=>{
    this.deptList =res
    this.deptList.push({dept_name:'All'})
  //  console.log(this.deptList)
  }, (error) => this.messageService.add({severity:'error',summary:error.messaage}))
}
...
getContra(){
  this.api.getContractor().subscribe(res =>{
    ...
    this.Con_list.push({Cont_company_name:'All',Con_Id:'All'})
   },error=>{
    console.log(error);
