...
export class PayscaleHeaderMasterComponent implements OnInit {
 ...
 // userEmpcode:string |null = sessionStorage.getItem('user_name');
  ...
  constructor(private fb: FormBuilder,
    ...
    private api : ClamAPIService,private service : ApiService,public loader: LoaderserviceService,private dialog: MatDialog,private messageService:MessageService,private confirmationService:ConfirmationService) {}
  ...
  onSubmit() {
    if (this.NewPayScaleFormGroup.valid) {
      ...
      this.api.NewPayscaleHeader(formData,this.userEmpcode).subscribe((res:any)=>{
        ...
        this.messageService.add({severity:'info',summary:'Payscale Header Added.'})
      },error =>{
  ...
  On_Update() {
    if (this.NewPayScaleFormGroup.valid) {
      ...
      this.api.updatePayscaleHeader(formData,this.userEmpcode).subscribe((res:any)=>{
        ...
        this.messageService.add({severity:'info',summary:'Payscale Header Updated!'})
      }, (error) =>{
  ...
  deletePayscale(event:Event,data: any) {
    this.confirmationService.confirm({
        target: event.target as EventTarget,
            ...
            accept: () => {this.deletePaycaleAPICall(data)},
            reject: () => {
  ...
  deletePaycaleAPICall(data:any){
   this.api.deletePayscaleHeader(data,this.userEmpcode).subscribe((res:any)=>{
    ...
    //  this.closeAllForms1()
      ...
      this.messageService.add({severity:'info',summary:'Payscale Header Deleted.'})
    },error =>{
