...
@NgModule({
  declarations: [
    ...
    // HolidayMasterComponent, declared in rml-user module
    // BillProcessedDateComponent, declared in rml-user module
    // DeclaredCompOffComponent, declared in rml-user module
    // IndirectHeadCountMasterComponent, declared in rml-user module
    // MonthFilterPipe, // declared in rml-user module
    // DeptFilterPipe, declared in rml-user module
    // IN_PlantFilterPipe, declared in rml-user module
    SalaryApprovalDeptFilterPipe,
    ...
    ShiftFilterPipe,StatusFilterPipe,CatgFilterPipe,
    CustomGenFilterPipe,ApproveGenFilterPipe,
