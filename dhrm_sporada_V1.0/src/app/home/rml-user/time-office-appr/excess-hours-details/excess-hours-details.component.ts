...
export class ExcessHoursDetailsComponent implements OnInit {
  ...
  excessHrData:any[]
  constructor(private dailog:MatDialogRef<ExcessHoursDetailsComponent>,@Inject(MAT_DIALOG_DATA) public data:any,private apiService:ApiService, private messageService:MessageService) { }
