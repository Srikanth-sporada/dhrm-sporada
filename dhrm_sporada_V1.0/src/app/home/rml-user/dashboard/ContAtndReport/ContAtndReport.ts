...
@Component({
  selector: 'app-contatndreport',
  templateUrl: './ContAtndReport.html',
  styleUrls: ['./ContAtndReport.css']
})
export class ContAtndComponent implements OnInit,OnChanges  {
  @Input() date:any;
  @Input() plant:any;
  ...
  barChartOptions: ChartConfiguration["options"]|any = {
    ...
    plugins: {
      ...
      // title: {
      //   display: true,
      //   text: "Contractor Wise Present / Absent Report (Appointed)",
      //   padding:20,
      //   font:{
      //     size:30
      //   }
