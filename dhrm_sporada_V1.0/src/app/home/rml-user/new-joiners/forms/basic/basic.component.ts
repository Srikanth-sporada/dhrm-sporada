...
export class BasicComponent implements OnInit {
    ...
    constructor(private fb: UntypedFormBuilder, private http: HttpClient, private cookie: CookieService, private formservice: FormService, private active: ActivatedRoute, private service: ApiService,private messageService:MessageService) {
    ...
    getdatabasic() {
        ...
        this.formservice.getdatabasic(this.uniqueId)
            .subscribe((data) => {
                ...
                this.form.controls['Caste'].setValue(this.basic[0]?.caste_name)
    ...
    // check aadhar number of trainee
