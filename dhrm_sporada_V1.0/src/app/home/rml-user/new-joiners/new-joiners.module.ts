...
import {CategoryComponent} from '../new-joiners/forms/category/category.component'
import {RejectComponent} from '../new-joiners/hr-view-data/reject/reject.component';
