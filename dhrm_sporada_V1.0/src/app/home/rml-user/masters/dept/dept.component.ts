...
getDepartmentHeader(){
  ...
  save()
  {
    ...
    .subscribe({
      ...
      {
        this.messageService.add({severity:'info',summary:'Department Code already exists!'})
      }else if(response.message == 'inserted'){
        this.messageService.add({severity:'info',summary:'Department Added Successfully'})
      }else if(response.message = 'failure'){
        this.messageService.add({severity:'error',summary:'cannot Add Department!'})
      }
    else
      {
  ...
  editSave()
  {
    ...
    .subscribe({
      ...
      if(response.message== 'already')
      {
        this.messageService.add({severity:'info',summary:'Already Exists!'})
      }else if(response.message == 'updated'){
        this.messageService.add({severity:'info',summary:'Department Updated!'})
      }else if(response.message == 'failure'){
        this.messageService.add({severity:'error',summary:'Cannot Update Department!'})
      }
    else
      {
        this.getDepartment();
...
deleteDepartment(event:Event,a:any, slno:any)
{
  ...
  this.confirmationService.confirm({
        target: event.target as EventTarget,
            ...
            accept: () => {this.deleteDepartmentAPICall(slno,a)},
            reject: () => {
...
deleteDepartmentAPICall(slno:any,a:any){
  ...
  .subscribe({
    ...
    if(response.message == 'success')
      ...
      this.messageService.add({severity:'info',summary:'Department Deleted'})
  },
  error: (err) => this.messageService.add({severity:'error',summary:err.message})
  })
}
...
filterByDepartment(){
  ...
  if(filteredDataByDepartment.length){
    ...
    this.department = this.departmentData;
    this.messageService.add({severity:'info',summary:'Department Not Found!'})
  }
}
