...
export class TraineeAnswerComponent implements OnInit {
  ...
  constructor(private active:ActivatedRoute, private service: ApiService,public loader:LoaderserviceService, private messageService:MessageService, private location:Location) {
