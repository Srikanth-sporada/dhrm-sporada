...
export class UpdatePayscaleComponent implements OnInit {
  ...
  constructor(private router: Router,private dialog: MatDialog, private api:ClamAPIService,public loader: LoaderserviceService) { }
...
//   this.router.navigate(['/rml/contra/updt_payscale/'], navigationExtras);
// }
