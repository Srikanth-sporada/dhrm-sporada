...
{ path:"newCon", component:ContractorOnboardComponent,
   canActivate: [Admin_HrApp_Hr],

  },
  

{path:"payroll", component:PayrollMasterComponent,
   canActivate: [Admin],

  },
{ path:"canteen", component:CanteenDeductionComponent,
   canActivate: [Admin],
...
{ path:"bonus", component:BonusMasterComponent,
   canActivate: [Admin],
 
  },

{ path:"el_mst", component:EarnedLeaveMasterComponent,
   canActivate: [Admin],
 
  },
{ path:"fhday_mst", component:HolidayMasterComponent,
   canActivate: [Admin],

  },
{ path:"ot_mst", component:OTLimitMasterComponent,
   canActivate: [Admin],

  },
{ path:"w-off_mst", component:WeekOffMasterComponent,
   canActivate: [Admin],
 
  },
{ path:"dcoff_Mst", component:DeclaredCompOffComponent,
   canActivate: [Admin],
    
  },
{ path:"dh_day_mst", component:DeclaredHolidayMasterComponent,
   canActivate: [Admin],
...
{ path:"trnsf_post", component:TransferPostingComponent,
canActivate: [Admin],
  },
{ path:"bill_pros_dt", component:BillProcessedDateComponent,
canActivate: [Admin],
  },
...
{ path:"rev_payscale/:apln_slno/:Con_ID/:gen_id/:apln_status/:PayScale_ID", component:RevisePayscaleComponent,
canActivate: [Admin_HrApp_Hr], 
},
{ path:"updt_payscale/:apln_slno/:Con_ID/:gen_id/:apln_status/:Salary_Status", component:ViewPayscaleComponent,
canActivate: [Admin_HrApp_Hr], 
},
{ path:"view_payscale/:view/:P_Id/:apln_slno/:Con_ID/:Effective_Date", component:ApprovePayscaleComponent,
  canActivate: [Admin_HrApp_Hr] 
},
{ path:"appr_payscale/:approve/:P_Id/:apln_slno/:Con_ID/:Effective_Date", component:ApprovePayscaleComponent,
  canActivate: [Admin_HrApp_Hr] 
},
// { path:"mst_payscale/:master/:Payscale_Id/:Con_ID/:Effective_Date", component:ApprovePayscaleComponent,
//   },
{ path:"apprl_salary", component:ApprovalSalaryComponent,
  canActivate: [Admin_HrApp_Hr]  },
